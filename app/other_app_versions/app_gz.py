...
# #url = urlparse.urlparse(os.environ["postgres://giatqnrdvmefnl:7f482067b19d65c0582e392906796e192b75c2b9aba6ed9f79f74948516352ff@ec2-23-21-220-167.compute-1.amazonaws.com:5432/d6qtdfmg2o6tha"])
# url = "postgres://giatqnrdvmefnl:7f482067b19d65c0582e392906796e192b75c2b9aba6ed9f79f74948516352ff@ec2-23-21-220-167.compute-1.amazonaws.com:5432/d6qtdfmg2o6tha"



# conn = psycopg2.connect(
#     database='d6qtdfmg2o6tha',
#     user='giatqnrdvmefnl',
#     password='7f482067b19d65c0582e392906796e192b75c2b9aba6ed9f79f74948516352ff',
...
#df = pd.read_csv("static/merged_recent_data.csv")
df = pd.read_csv('static/merged_recent_data.csv.gz')
# df = pd.read_sql("SELECT * FROM recent_merged_projects LIMIT(5000)", conn)
