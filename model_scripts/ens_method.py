...
print "Step 2...splitting training and test set..."
x_train, x_test, y_train, y_test = train_test_split(
    X, y, test_size=0.25, random_state=7)
print "Step 2...done splitting training and test set"
...
test_model("DT-md-8", DecisionTreeClassifier(max_depth = 8, class_weight = "auto" ))
test_model("DT-md-4", DecisionTreeClassifier(max_depth = 4, class_weight = "auto" ))
test_model("DT-n-45000", DecisionTreeClassifier(min_samples_split = 45000, max_depth = 6, class_weight = "auto" ))
